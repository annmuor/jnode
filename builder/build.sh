#!/bin/sh
TIME=$(A="`git rev-parse HEAD`" && echo ${A:0:8})
...
mvn clean package -f ../pom.xml -pl jnode-core,jnode-httpd-module,jnode-mail-module,jnode-rss -am && \
echo "Run!"
for I in jnode-core jnode-httpd-module jnode-mail-module jnode-rss; do
    RPATH="../$I"
...
cd "$TEMP"
zip -r ../jnode-1.4-release-multidb-$TIME.zip jnode
cd ..
rm -r "$TEMP"
