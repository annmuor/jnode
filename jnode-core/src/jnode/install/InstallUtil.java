...
public class InstallUtil {
    ...
    private void version1_5(Version ver) {
        execQuery("ALTER TABLE schedule ADD COLUMN nextRunDate TIMESTAMP NULL;");
        execQuery("ALTER TABLE schedule DROP COLUMN details;");
    ...
    private void version1_4(Version ver) {
        try {
    ...
    private void version1_3(Version ver) {
    ...
    private void version1_2(Version ver) {
        try {
    ...
    private void version1_1(Version ver) {
        try {
    ...
    private void version1_0(Version ver) {
